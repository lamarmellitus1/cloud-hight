...
resource "aws_autoscaling_group" "cloudhight-asg_name" {
  ...
  launch_template {
    ...
    version = aws_launch_template.cloudhight.latest_version
  }
}
...
resource "aws_autoscaling_policy" "scale_up" {
  ...
  autoscaling_group_name = aws_autoscaling_group.cloudhight-asg_name.name
...
resource "aws_cloudwatch_metric_alarm" "scale_up_alarm" {
  ...
  dimensions = {
    "AutoScalingGroupName" = aws_autoscaling_group.cloudhight-asg_name.name
  }
